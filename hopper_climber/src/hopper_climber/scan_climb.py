...
class BlindClimbController(object):
    ...
    def step_left(self, vector):
        ...
        request.leg_positions.left_front.z = 0.05
    ...
    def step_right(self, vector):
        # lift left
        request = MoveLegsToRelativePositionRequest()
        request.leg_positions.right_front.z = 0.05
    ...
    def test_relative_move(self, obstacle_height):
        ...
        self.move_legs_relative(request)
        request = MoveLegsToRelativePositionRequest()
        request.leg_positions.left_middle.x = 0.07
        request.leg_positions.right_middle.x = 0.07
        self.move_legs_relative(request)
        request = MoveLegsToRelativePositionRequest()
        request.leg_positions.left_middle.z = -0.05
        request.leg_positions.right_middle.z = -0.05
        ...
        # raise front legs
        request = MoveLegsToRelativePositionRequest()
        request.leg_positions.left_front.z = obstacle_height + 0.04
        request.leg_positions.left_front.y = 0.07
        request.leg_positions.right_front.z = obstacle_height + 0.04
        request.leg_positions.right_front.y = -0.07
        self.move_legs_relative(request)
        # move front legs forward
        request = MoveLegsToRelativePositionRequest()
        request.leg_positions.left_front.x = 0.15
        request.leg_positions.left_front.y = -0.07
        request.leg_positions.right_front.x = 0.15
        request.leg_positions.right_front.y = 0.07
        self.move_legs_relative(request)
        request = MoveLegsToRelativePositionRequest()
        ...
        request.leg_positions.left_rear.x = 0.09
        request.leg_positions.right_rear.z = 0.03
        request.leg_positions.right_rear.x = 0.09
        self.move_legs_relative(request)
        request = MoveLegsToRelativePositionRequest()
        request.leg_positions.left_rear.z = -0.03
        request.leg_positions.left_rear.x = 0.09
        ...
        # move middle legs
        request = MoveLegsToRelativePositionRequest()
        request.leg_positions.left_middle.z = obstacle_height + 0.05
        request.leg_positions.left_middle.x = 0.14
        request.leg_positions.right_middle.z = obstacle_height + 0.05
        request.leg_positions.right_middle.x = 0.14
        self.move_legs_relative(request)
        request = MoveBodyRelativeRequest()
        ...
        self.move_body_relative(request)
        request = MoveLegsToRelativePositionRequest()
        request.leg_positions.left_rear.z = obstacle_height + 0.04
        request.leg_positions.left_rear.x = 0.06
        request.leg_positions.right_rear.z = obstacle_height + 0.04
