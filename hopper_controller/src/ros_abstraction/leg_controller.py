...
class LegController(object):
    ...
    def move_legs(self, move_legs_cmd):
        ...
        new_positions.left_front = (move_legs_cmd.left_front + frame_transform) / 100.0
        new_positions.right_front = (move_legs_cmd.right_front + frame_transform) / 100.0
        new_positions.left_middle = (move_legs_cmd.left_middle + frame_transform) / 100.0
        new_positions.right_middle = (move_legs_cmd.right_middle + frame_transform) / 100.0
        new_positions.left_rear = (move_legs_cmd.left_rear + frame_transform) / 100.0
        new_positions.right_rear = (move_legs_cmd.right_rear + frame_transform) / 100.0
