...
class IkController(object):
    def __init__(self):
        ...
        self.read_legs_service_proxy = rospy.ServiceProxy("hopper/ik/read_leg_positions", ReadHexapodLegPositions, persistent=True)
    ...
    def read_current_leg_positions(self):
        leg_positions_msg = self.read_legs_service_proxy().leg_positions
